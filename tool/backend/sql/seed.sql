...
INSERT INTO rti_status_histories (rti_request_id, status_id, direction, description, entry_time, created_at, files) 
SELECT id, (SELECT id FROM rti_statuses WHERE name = 'CREATED' LIMIT 1), 'sent', 'RTI Request Created', created_at, created_at, '[]'
FROM rti_requests;

-- Now add follow-up histories for specific scenarios
-- Scenario 1: Inquiry on Hospital Supplies (APPROVAL -> ACCEPTED -> DELIVERY)
INSERT INTO rti_status_histories (rti_request_id, status_id, direction, description, entry_time, created_at, files) VALUES 
((SELECT id FROM rti_requests WHERE title = 'Inquiry on Hospital Supplies' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVAL' LIMIT 1), 'sent', 'Initial request submitted for internal approval.', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days' + INTERVAL '1 second', '["requests/req_001.pdf"]'),
((SELECT id FROM rti_requests WHERE title = 'Inquiry on Hospital Supplies' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'ACCEPTED' LIMIT 1), 'sent', 'Request approved by the designated official.', NOW() - INTERVAL '9 days', NOW() - INTERVAL '9 days' + INTERVAL '1 second', '[]'),
((SELECT id FROM rti_requests WHERE title = 'Inquiry on Hospital Supplies' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'DELIVERY' LIMIT 1), 'sent', 'Request officially forwarded to the Ministry of Health.', NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days' + INTERVAL '1 second', '[]');

-- Scenario 2: School Expenditure 2024 (APPROVAL -> REJECTED -> APPROVAL -> ACCEPTED -> DELIVERY -> COMPLETED)
INSERT INTO rti_status_histories (rti_request_id, status_id, direction, description, entry_time, created_at, files) VALUES 
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVAL' LIMIT 1), 'sent', 'Initial submission.', NOW() - INTERVAL '20 days', NOW() - INTERVAL '20 days' + INTERVAL '1 second', '["requests/req_002_v1.pdf"]'),
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'REJECTED' LIMIT 1), 'sent', 'Rejected: Missing required attachments.', NOW() - INTERVAL '19 days', NOW() - INTERVAL '19 days' + INTERVAL '1 second', '[]'),
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVAL' LIMIT 1), 'sent', 'Resubmitted with correct documents.', NOW() - INTERVAL '18 days', NOW() - INTERVAL '18 days' + INTERVAL '1 second', '["requests/req_002_v2.pdf"]'),
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'ACCEPTED' LIMIT 1), 'sent', 'Verified and approved.', NOW() - INTERVAL '17 days', NOW() - INTERVAL '17 days' + INTERVAL '1 second', '[]'),
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'DELIVERY' LIMIT 1), 'sent', 'Sent to Dept of Education.', NOW() - INTERVAL '16 days', NOW() - INTERVAL '16 days' + INTERVAL '1 second', '[]'),
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'COMPLETED' LIMIT 1), 'received', 'Final response received and shared.', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days' + INTERVAL '1 second', '["responses/data_002.zip"]');

-- Scenario 3: Highway Project Budget (APPROVAL -> ACCEPTED -> DELIVERY -> ACKNOWLEDGE(received) -> ACKNOWLEDGE(sent) -> COMPLETED)
INSERT INTO rti_status_histories (rti_request_id, status_id, direction, description, entry_time, created_at, files) VALUES 
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVAL' LIMIT 1), 'sent', 'Initial request submitted.', NOW() - INTERVAL '15 days', NOW() - INTERVAL '15 days' + INTERVAL '1 second', '["requests/req_003.pdf"]'),
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'ACCEPTED' LIMIT 1), 'sent', 'Internal approval granted.', NOW() - INTERVAL '14 days', NOW() - INTERVAL '14 days' + INTERVAL '1 second', '[]'),
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'DELIVERY' LIMIT 1), 'sent', 'Forwarded to RDA.', NOW() - INTERVAL '13 days', NOW() - INTERVAL '13 days' + INTERVAL '1 second', '[]'),
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'ACKNOWLEDGE' LIMIT 1), 'received', 'Receiver requested clarification on project phase.', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days' + INTERVAL '1 second', '["clarifications/RDA_query.pdf"]'),
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'ACKNOWLEDGE' LIMIT 1), 'sent', 'Clarification provided and forwarded.', NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days' + INTERVAL '1 second', '["clarifications/RDA_reply.pdf"]'),
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'COMPLETED' LIMIT 1), 'received', 'Final report issued.', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days' + INTERVAL '1 second', '["responses/final_report_003.pdf"]');

-- Scenario 4: Environmental Clearance List (APPROVAL -> ACCEPTED -> DELIVERY)
INSERT INTO rti_status_histories (rti_request_id, status_id, direction, description, entry_time, created_at, files) VALUES 
((SELECT id FROM rti_requests WHERE title = 'Environmental Clearance List' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVAL' LIMIT 1), 'sent', 'New request waiting for review.', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days' + INTERVAL '1 second', '["requests/req_004.pdf"]'),
((SELECT id FROM rti_requests WHERE title = 'Environmental Clearance List' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'ACCEPTED' LIMIT 1), 'sent', 'Approved by Senior Secretary.', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day' + INTERVAL '1 second', '[]'),
((SELECT id FROM rti_requests WHERE title = 'Environmental Clearance List' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'DELIVERY' LIMIT 1), 'sent', 'Emailed to CEA.', NOW() - INTERVAL '1 hour', NOW() - INTERVAL '1 hour' + INTERVAL '1 second', '[]');
